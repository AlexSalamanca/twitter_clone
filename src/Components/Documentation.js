...
export default function Documentation(){
    return(
        <div>
            ...
            <h3>Tutorials</h3>
            <ul>
                <li><a href="https://www.smashingmagazine.com/2020/04/dark-mode-react-apps-styled-components/" target="_blank">Implement the theme switcher</a></li>
                <li><a href="https://www.youtube.com/watch?v=7CqJlxBYj-M&t=5206s" target="_blank">Connect backend with frontend</a></li>
                <li><a href="https://www.youtube.com/watch?v=-RCnNyD0L-s&t=941s" target="_blank"></a>Login System(https://www.youtube.com/watch?v=-RCnNyD0L-s&t=941s) anchor not working for some reason</li>
            </ul>
        </div>
    );
}